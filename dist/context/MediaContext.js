...
exports.MediaProvider = exports.useMedia = void 0;
...
// Crear el contexto
const MediaContext = (0, react_1.createContext)(media);
// Hook para acceder al contexto
const useMedia = () => (0, react_1.useContext)(MediaContext);
exports.useMedia = useMedia;
// Proveedor del contexto
const MediaProvider = ({ children }) => {
    return ((0, jsx_runtime_1.jsx)(MediaContext.Provider, { value: media, children: children }));
};
