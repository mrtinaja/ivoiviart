...
const ArtisticButton = ({ onClick, children, className = "", }) => {
    return (_jsxs(motion.button, { onClick: onClick, className: `relative overflow-hidden px-6 py-3 text-lg font-semibold text-white rounded-md 
        ...
        }, transition: { duration: 0.3 }, children: [_jsx("span", { className: "absolute inset-0 bg-white opacity-10 blur-lg" }), children] }));
};
